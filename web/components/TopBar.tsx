    ...
    <div className="bg-blue-700 text-blue-50">
      <Container className="flex flex-col gap-2 py-2 text-xs sm:flex-row sm:items-center sm:justify-between sm:text-sm">
        ...
        <div className="flex flex-wrap items-center gap-2 sm:gap-3">
          <a href={`mailto:${siteContent.global.email}`} className="rounded-full bg-blue-600/60 px-2 py-0.5 opacity-90 hover:opacity-100">
            {siteContent.global.email}
          </a>
          <span className="h-1 w-1 rounded-full bg-blue-200" />
          <a href="tel:+14168225245" className="rounded-full bg-blue-600/60 px-2 py-0.5 opacity-90 hover:opacity-100">
            {siteContent.global.phone}
          </a>
          <span className="h-1 w-1 rounded-full bg-blue-200" />
          <a href={siteContent.global.whatsapp} className="rounded-full bg-blue-600/60 px-2 py-0.5 opacity-90 hover:opacity-100">
            WhatsApp
          </a>
        </div>
      </Container>
